...
import {Wrapper, P, Button, Input} from '../styledComponents';
import {CurrentInstructorContext, InstructorContext, UserContext} from '../../Context';
import axios from 'axios';

const StudentCalendar = ({selectedTime, setSelectedTime, selectedMonth, setSelectedMonth, getDays, loading, setLoading}) => {

    const {refresh, setRefresh} = useContext(InstructorContext);
